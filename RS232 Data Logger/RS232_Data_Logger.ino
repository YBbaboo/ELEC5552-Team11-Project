...
void loop() {
  ...
  if (RS232Serial.available() > 0) {
    ...
    //String inputStringM = "!*A_1.50_(91)(100)";
  ...
  if (Rate > 0) {
    ...
    String dataA = RS232Serial.readStringUntil('(');  // 假设每行以括号结尾
    Serial.println(dataA);
    
    //String inputStringA = "!0AFILM1___1.23_150_1.23_1.234_1.234_0_12(140)(40)";
    // find the underscore
